-- Migration: Add Creator Avatar to Shared Program
-- Date: 2026-01-23
-- Description: Updates get_shared_program function to include creator's avatar from auth metadata

-- =====================================================
-- 1. UPDATE get_shared_program FUNCTION TO INCLUDE AVATAR
-- =====================================================
...
COMMENT ON FUNCTION get_shared_program IS 'Public function to retrieve shared program data by token, including creator name and avatar';
